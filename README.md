...
* Query.sql contains several SQL queries regarding the employee data. Copy the desired query to the Query Editor and run it on the database:
    + Identification (name, number, and gender) for all employees and their salary
    + Employees hired in 1986
    + Department Managers and the departments they manage
    + The name of each employee and their department
    + Employees with the last name of 'Hercules' whose first name begins with 'B'
    + All the employees in the Sales department
    + All the employees in the Sales or Development departments
    + Last names grouped by how often they occur, with the most frequent first
